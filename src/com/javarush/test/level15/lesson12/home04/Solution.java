...
//        if ( (Planet.SUN).equals(parameter))
//        {
//            thePlanet = Sun.getInstance();
//        }
//        else if ( (Planet.EARTH).equals(parameter))
//        {
//            thePlanet = Earth.getInstance();
//        }
//        else if ( (Planet.MOON).equals(parameter))
//        {
...
//        else thePlanet = null;
        ...
        while (true)
        {
            ...
            if (Planet.EARTH.equals(parameter))
            {
                thePlanet = Earth.getInstance();
                break;
            }
            if (Planet.MOON.equals(parameter))
            {
                thePlanet = Moon.getInstance();
                break;
            }
